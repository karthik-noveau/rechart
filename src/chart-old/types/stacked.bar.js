...
export const StackedBar = () => {
  ...
  const [brushIndex, setBrushIndex] = useState([0, 10]);
  ...
  const BarShape = (props) => {
    const { fill, x, y, width, height, borderRadius = 6 } = props;

    // Correct path with border radius
    ...
    <Wrapper>
      <ResponsiveContainer width="100%" height={400}>
        <BarChart
          ...
          barGap={30} // Adjust gap between bars
          barCategoryGap="25%" // Adjust gap between categories
